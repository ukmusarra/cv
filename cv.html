 /\*html { height:297mm; width:210mm; margin-left:auto; margin-right:auto; }\*/ .header { background:white; border:0px solid black; padding: 0px; margin: 0px; font-size: 12px; } .header .left { background:white; margin: 0px; padding: 0px; flex-basis:70%; } .header .middle { background:white; margin: 0px; padding: 0px; flex-basis:20%; } .header .right { background:white; margin: 0px; padding: 0px; flex-basis:10%; } /\* .header .right ul { list-style-type:none; padding:0px; margin:0px; display: flex; flex-wrap: wrap; flex-direction: column; height: 51.2px; align-items:center; justify-content:space-evenly; } \*/ .exesummary { background:white; border:0px solid black; padding: 4px; margin: 0px; font-size: 30px; text-align: justify; } .associations { background:white; border:0px solid black; padding: 4px; margin: 0px; font-size: 30px; text-align: justify; } .wkexp { background:white; border:0px solid black; font-size: 30px; margin: 0px; padding: 0px; text-align: justify; } .main { border: 0px solid black; padding: 10px; margin: 10px 10px 0px 0px; font-size: 28px; } .main .left { background:white; margin:5px 5px 0px 0px; padding: 5px 5px 0px 0px; flex-basis:20%; } .main .right { margin:5px 0px 0px 5px; padding: 5px 0px 0px 5px; background:white; flex-basis:80%; } .education { background:white; border:0px solid black; padding:0px; margin:0px; font-size: 30px; text-align: justify; } .publications { background:white; border:0px solid black; padding:0px; margin:0px; font-size: 30px; text-align: justify; } .development { background:white; border:0px solid black; padding:0px; margin:0px; font-size: 30px; text-align: justify; } .extra { background:white; border:0px solid black; padding: 0px; margin: 0px; font-size: 30px; text-align: justify; } .extra ul { list-style-type:none; padding:0px; margin:0px; display: flex; flex-wrap: wrap; flex-direction: column; height: 100px; align-items:center; justify-content:space-evenly; } .extra li { margin: 8px; padding: 2px; background: white; border:0px solid black; font-size: 30px; font-weight:bolder; } body { margin:0px; background:white; color:black; font-family: 'Helvetica', 'Arial', sans-serif; } /\* .row { display:flex; page-break-inside: avoid; background:white; } \*/ .header .row { display:flex; background:white; justify-content: center; align-items: center; } .row:after { content: ""; display: table; clear: both; } .hr{ padding: 0px; margin: 0px; border:0px outset grey; height: 10px; } /\* h1 { margin: 0px; padding: 0px; } \*/ h2 { margin: 0px; padding: 0px; background: white; /\*#ECEBEB;\*/ color:FireBrick; } p { margin: 2px 0px; padding: 2px 0px; line-height: 1.6; } ul { line-height: 1.8; } /\* .header .left { background:blue; padding: 0px; } .head {font-family:"verdana";font-size-adjust:0.58;background:lightgray;} .head h1 {display:inline;margin:0px;} .exesummary {font-family:"verdana"font-size-adjust:0.58;} .exesummary p {color:blue;} .exesummary h2 {background:lightgray;} @media only screen and (max-width: 500px) {.head, .exesummary {width: 100%; margin-left: 5px;}} @media screen and (max-width: 426px) {.header .left, .header .middle, .header .right {width:100%;text-align:center;background:lightgray;} @media screen and (max-width: 426px) {.main .left, .main .middle, .main .right {width:100%;text-align: center;background:lightgray;} @media screen and (max-width: 700px) {.row {flex-direction:column;text-align:center;background:white;}} @media screen and (max-width: 700px) {ul {list-style-type:none;margin:5px 0px;padding:5px 0px;}} @media screen and (max-width: 700px) {li {margin:5px 0px;padding:5px 0px;}} @media screen and (max-width: 700px) {.exesummary li {background:MintCream;}} @media screen and (max-width: 700px) {.extra ul {width:100%;height:100%;text-align:center;background:white;}} @media screen and (max-width: 700px) {html {width:100%;}} @media screen and (max-width: 700px) {.header, .exesummary, .wkexp, .associations, .education, .extra {font-size: 16px;margin:15px;padding:15px;text-align: center;}} @media screen and (max-width: 700px) {.main .left {flex-basis:100%; background:LightYellow;margin:0px;padding:0px;text-align: center;}} @media screen and (max-width: 700px) {.main .right{flex-basis:100%; background:white;margin:0px;padding:0px;text-align: center;}} @media screen and (max-width: 700px) {.profile {display: none;}} @media screen and (max-width: 700px) {h2 {flex-basis:100%; background:LightYellow;color:black;margin:0px;padding:15px;text-align: center;}} @media screen and (max-width: 700px) {.extra li {font-size: 16px;margin:5px;padding:5px;background:LightYellow;}} @media screen and (max-width: 700px) {p {font-size: 16px;margin:20px 0px;padding:2px 0px;border:0px solid black;}} \*/
